...
void hal_gpio_init( void )
{
    ...
    hal_mcu_wait_ms( 500 ); // re-power up LR1110
    ...
    hal_gpio_init_in( USER_BUTTON, HAL_GPIO_PULL_MODE_NONE, HAL_GPIO_IRQ_MODE_OFF, NULL );

    hal_gpio_init_out( USER_LED_G, HAL_GPIO_RESET );
    hal_gpio_init_out( USER_LED_R, HAL_GPIO_RESET );

    hal_gpio_init_in( CHARGER_DONE, HAL_GPIO_PULL_MODE_NONE, HAL_GPIO_IRQ_MODE_OFF, NULL );
    hal_gpio_init_in( CHARGER_CHRG, HAL_GPIO_PULL_MODE_NONE, HAL_GPIO_IRQ_MODE_OFF, NULL );
}
